    ...
    <>
      ...
      <div className='w-screen h-screen flex flex-col justify-center bg-gradient-to-r from-white to-black'>
        <div className='w-1/2 m-auto'>
          <div className='bg-abu-super-gelap text-white rounded-lg text-6xl p-5 w-1/2 m-auto flex justify-center'>Compute<a className='bg-oranye rounded-lg font-bold text-abu-super-gelap'>HUB</a></div>
          <div className='bg-abu-super-gelap py-5 px-16 mt-10 w-full m-auto flex flex-col border rounded-3xl place-content-center'>
            ...
            <div class="text-white text-xl text-center mt-3">Doesn't have an account? &nbsp;<Link to="/register"><a class="font-semibold text-oranye">Register Now!</a></Link></div>
            <div class="flex">
              <Link to="/">
                ...
                <button type="submit" name="home" class="my-5 text-lg font-extrabold mr-auto px-7 py-3 flex text-abu-super-gelap rounded-lg bg-oranye">
                  HOME
                </button>
              </Link>
              ...
              <button type="submit" name="login" class="my-5 text-lg font-extrabold ml-auto px-7 py-3 text-abu-super-gelap rounded-lg bg-oranye">LOGIN</button>
            </div>
          </div>
        </div>
      </div>
