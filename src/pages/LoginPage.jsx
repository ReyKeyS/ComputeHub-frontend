          ...
          <div className='bg-abu-super-gelap py-5 px-16 mt-10 w-full m-auto flex flex-col border rounded-3xl place-content-center'>
            ...
            <div class="flex">
              <Link to="/">
                ...
                <button type="submit" name="home" formaction="index.php" class="my-5 text-lg font-bold mr-auto px-7 py-3 flex text-abu-super-gelap rounded-lg bg-oranye">
                  HOME
                </button>
              </Link>
              ...
              <button type="submit" name="login" class="my-5 text-lg font-bold ml-auto px-7 py-3 text-abu-super-gelap rounded-lg bg-oranye">LOGIN</button>
            </div>
          </div>
        </div>
      </div>
