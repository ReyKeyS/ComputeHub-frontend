...
function LoginPage() {
  return (
    <>
        ...
        <div className='w-screen h-screen flex justify-center bg-gradient-to-r from-white to-black'>
          <div className='bg-white py-5 px-16 w-full m-auto flex flex-col border rounded-xl place-content-center'>
