        ...
        <div className='w-screen h-screen flex flex-col justify-center bg-gradient-to-r from-white to-black'>
            <div className='w-1/2 m-auto'>
                ...
                <div className='bg-abu-super-gelap py-5 px-16 mt-2 w-full m-auto flex flex-col border rounded-3xl place-content-center'>
                    ...
                    <div class="text-white text-xl text-center mt-3">Already have an account? &nbsp;<Link to="/login"><a class="font-semibold text-oranye">Login Now!</a></Link></div>
                    <div class="flex">
                        <Link to="/">
                        ...
                        <button type="submit" name="register" class="my-5 text-lg font-extrabold ml-auto px-7 py-3 text-abu-super-gelap rounded-lg bg-oranye">REGISTER</button>
                    </div>
                </div>
            </div>
        </div>
